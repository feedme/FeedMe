...
namespace EnterpriseProject {
    ...
    public partial class MyWebProfile {
        ...
        public MyWebProfile(System.Web.Profile.ProfileBase profileBase) {
            this._profileBase = profileBase;
        }
        
        public static MyWebProfile Current {
            get {
                return new MyWebProfile(System.Web.HttpContext.Current.Profile);
            }
        }
        ...
        public static MyWebProfile GetProfile(string username) {
            return new MyWebProfile(System.Web.Profile.ProfileBase.Create(username));
        }
        
        public static MyWebProfile GetProfile(string username, bool authenticated) {
            return new MyWebProfile(System.Web.Profile.ProfileBase.Create(username, authenticated));
        }
